...
return [
    ...
    'ldap_wizard' => [
        ...
        'sasl_external_requires_cert' => 'SASL EXTERNAL bind requires a client TLS certificate and key. Configure both on the Connection step before enabling this option.',
    ...
    'ldap_use_sasl_external_bind' => 'Use SASL EXTERNAL bind (authenticate with client certificate)',
    'ldap_use_sasl_external_bind_help' => 'When enabled, Snipe-IT authenticates to the directory using the client TLS certificate and key configured on the Server step, and the Bind DN/UPN and Bind Password below are ignored. Required for Google Workspace LDAP deployments that use certificate-based authentication.',

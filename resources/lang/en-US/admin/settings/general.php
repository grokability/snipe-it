...
return [
    ...
    'require_checkout_document' => 'Require a checkout document',
    'require_checkout_document_help' => 'When enabled, an active checkout template with a published version must exist — checkouts will warn if the document could not be generated.',
    'document_prefixes' => 'Document number prefixes',

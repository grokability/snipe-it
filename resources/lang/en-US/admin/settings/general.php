...
return [
    ...
    'login_note_placeholder'            => "If you do not have a login or have found a device belonging to this department, please call technical support at 888-555-1212. Thank you.",
    ...
    'full_multiple_companies_support_help_text' => 'Restricting users (including admins) assigned to departments to their department\'s assets.',
    'full_multiple_companies_support_text' => 'Full Multiple Departments Support',
    'scope_locations_fmcs_support_text'  => 'Scope Locations with Full Multiple Departments Support',
    'scope_locations_fmcs_support_help_text'  => 'Restrict locations to their selected department.',
    ...
    'label2_title_help_phold' => 'The placeholder <code>{COMPANY}</code> will be replaced with the asset&apos;s department name',
    'label2_asset_logo'       => 'Use Asset Logo',
    'label2_asset_logo_help'  => 'Use the logo of the asset&apos;s assigned department, rather than the value at <code>:setting_name</code>',
    ...
    'keywords' => [
        ...
        'general_settings'  => 'department support, signature, acceptance, email format, username format, images, per page, thumbnail, eula, gravatar, tos, dashboard, privacy',

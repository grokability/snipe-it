...
return [
    ...
    'sync_adapter_sync_now' => 'Sync Now',
    ...
    'sync_adapter_large_fleet_note' => 'For large fleets, schedule the CLI command :command instead of clicking Sync Now.',
    ...
    'sync_adapter_user_match_email' => 'Match by email address',
    'sync_adapter_user_match_username' => 'Match by username',
    ...
    'sync_adapter_checkin_on_null_user_help' => 'When the vendor stops reporting an assigned user for a device, check the asset in from whoever had it. Off by default because a single missed sync cycle (device offline, empty field on a fresh enrollment) would flap the assignment. Turn this on only if you trust your vendor\'s user reporting to be consistent every sync.',
    ...
    'sync_adapter_active_help' => 'When off, scheduled runs and manual Sync Now clicks both skip this adapter. Stored credentials stay intact so you can re-enable without reconfiguring.',

...
return [
    ...
    'tag_color_help' => 'Se você deseja usar um indicador de cor personalizado para este registro, insira um código de cor hexadecimal (por exemplo, #ffffff para branco). Caso contrário, você pode deixar este campo em branco.',
    'checkin' => 'Check-in',
    ...
    'updated_before' => 'Atualizado Antes',
    'updated_plain' => 'Atualizado',
    ...
    'depreciation_type' => 'Tipo de Depreciação',
    ...
    'first_checkout' => '1<sup>o</sup> Check-out',
    'generate' => 'Gerar',
    'generate_labels' => 'Gerar Etiquetas',
    'github_markdown' => 'Este campo aceita <a href="https://help.github.com/articles/github-flavored-markdown/" target="_blank">marcação com sintaxe do Github</a>.',
    'groups' => 'Grupos',
    ...
    'import' => 'Importar',
    'documentation' => 'Abrir documentação em um novo link',
    'import_this_file' => 'Mapear os campos e processar este arquivo',
    'importing' => 'Importando',
    'importing_help' => 'O CSV deve ser delimitado por vírgulas e formatado com cabeçalhos que correspondam aos do <a href="https://snipe-it.readme.io/docs/importing" target="_new">exemplo de CSVs na documentação <i class="fa fa-external-link"></i></a>.',
    ...
    'accepted' => 'aceitar',
    'declined' => 'recusar',
    'declined_date' => 'Data Rejeitada',
    'declined_note' => 'Notas Rejeitadas',
    'unassigned' => 'Não atribuído',
    'unaccepted_asset_report' => 'Itens Não Aceitos',
    'users' => 'Usuários',
    'viewall' => 'Ver todos',
    ...
    'file_not_inlineable' => 'O arquivo solicitado não pode ser aberto inline no seu navegador. Você pode baixá-lo em vez disso.',
    ...
    'i_accept' => 'Eu aceito',
    'i_accept_with_count' => 'Eu aceito :count item|Eu aceito :count itens',
    'i_decline_item' => 'Recusar este item|Recusar estes itens',
    'i_accept_item' => 'Aceitar este item|Aceitar estes itens',
    'i_decline' => 'Eu recuso',
    'i_decline_with_count' => 'Eu recuso :count item|Eu recuso :count itens',
    ...
    'setup_next' => 'Próxima',
    'setup_done' => 'Configuração Completa!',
    'bulk_edit_about_to' => 'Você está prestes a editar o seguinte: ',
    'checked_out' => 'Disponibilizado',
    'checked_out_to' => 'Disponibilizado para',
    'available_users' => 'Usuários Disponíveis para Adicionar',
    'add_users_to_group' => 'Adicionar Usuários ao Grupo',
    'users_to_add_to_group' => 'Usuários para Adicionar',
    'add_all_users_to_group' => 'Adicionar todos os usuários ao grupo',
    'add_selected_users_to_group' => 'Adicionar usuários selecionados ao grupo',
    'remove_selected_users_from_group' => 'Remover usuários selecionados do grupo',
    'remove_all_users_from_group' => 'Remover todos os usuários do grupo',
    'add_users_to_group_help' => 'Use as setas para adicionar ou remover usuários deste grupo. Você pode selecionar vários usuários pressionando a tecla Ctrl (Windows) ou Command (Mac) enquanto clica.',
    'fields' => 'Campos',
    ...
    'send_welcome_email_help' => 'Apenas usuários com um endereço de e-mail válido e marcados como ativados receberão um e-mail de boas-vindas onde poderão redefinir sua senha.',
    'send_welcome_email_import_help' => 'Apenas novos usuários com um endereço de e-mail válido e marcados como ativados no seu arquivo de importação receberão um e-mail de boas-vindas onde poderão definir sua senha.',
    ...
    'system_default' => 'Usar Configurações do Sistema',
    'system_default_help' => 'Isso irá redefinir suas preferências de modo claro/escuro para usar as configurações padrões definidas nas preferências do sistema operacional do seu computador.',
    'theme' => 'Theme',
    'error_user_company' => 'A empresa alvo do checkout e a empresa do ativo não correspondem',
    'error_user_company_multiple' => 'Uma ou mais das empresas alvo do checkout e da empresa do ativo não correspondem',
    ...
    'error_assets_already_checked_out' => 'Uma ou mais dos ativos já estão disponibilizados',
    ...
    'sign_in_place' => 'Assinar/Aceitar no local',
    'sign_in_place_help' => 'Marque esta caixa se você tiver o usuário presente e desejar que ele aceite o item e assine/aceite o EULA (quando aplicável) agora.',
    'unauthorized' => 'Não autorizado ou não autenticado.',
    'importer' => [
    ...
    'show_inactive' => 'Expirado ou Terminado',
    'show_expiring' => 'Expirando ou Terminando em Breve',
    ...
    'by' => 'Por',
    'by_user' => 'Por',
    'ldap_sync_location' => 'Sincronizar Todos os Usuários para Este Local (Opcional)',
    'version' => 'Versão',
    'build' => 'construir',
    ...
    'upload_deleted' => 'Upload Excluído',
    'child_locations' => 'Locais Filhos',
    'append' => 'Acrescentar',
    'optional' => 'OPTIONAL',
    'audit_by_field' => 'Auditoria por Campo',
    'audit_by_field_help' => 'A auditoria por números de série é apenas uma opção disponível se os números de série forem necessários para serem únicos nas Configurações do Administrador.',
    'audit_key' => 'Ativo',
    ...
    'bulk_delete_associations' => [
        'general_assoc_warning' => ':item_name ainda tem itens associados. Por favor, remova-os antes de excluir este :item.',
        'assoc_assets' => ':item_name está atualmente associado com :asset_count ativo(s) e não pode ser excluído. Por favor, atualize seus ativos para não referenciar este :item e tente novamente.',
        'asset_models' => ':item_name está atualmente associado com :asset_count modelo(s) de ativo e não pode ser excluído. Por favor, atualize seus modelos de ativo para não referenciar este :item e tente novamente.',
        'assoc_maintenances' => ':item_name está atualmente associado com :maintenance_count manutenção(s) e não pode ser excluído. Por favor, atualize suas manutenções para não referenciar este :item e tente novamente.',
        'assoc_accessories' => ':item_name está atualmente associado com :accessory_count acessório(s) e não pode ser excluído. Por favor, atualize seus acessórios para não referenciar este :item e tente novamente.',
        'assoc_consumables' => ':item_name está atualmente associado com :consumable_count consumível(s) e não pode ser excluído. Por favor, atualize seus consumíveis para não referenciar este :item e tente novamente.',
        'assoc_components' => ':item_name está atualmente associado com :component_count componente(s) e não pode ser excluído. Por favor, atualize seus componentes para não referenciar este :item e tente novamente.',
        ...
        'assoc_assets_no_count' => ':item_name está atualmente associado com outros ativos e não pode ser excluído. Por favor, atualize seus ativos para não referenciar este :item e tente novamente.',
        'asset_models_no_count' => ':item_name está atualmente associado com outros modelos de ativo e não pode ser excluído. Por favor, atualize seus ativos para não referenciar este :item e tente novamente.',
        'assoc_maintenances_no_count' => ':item_name está atualmente associado com outras manutenções e não pode ser excluído. Por favor, atualize suas manutenções para não referenciar este :item e tente novamente.',
        'assoc_accessories_no_count' => ':item_name está atualmente associado com outros acessórios e não pode ser excluído. Por favor, atualize seus acessórios para não referenciar este :item e tente novamente.',
        'assoc_consumables_no_count' => ':item_name está atualmente associado com outros consumíveis e não pode ser excluído. Por favor, atualize seus consumíveis para não referenciar este :item e tente novamente.',
        ...
        'assoc_licenses_no_count' => ':item_name está atualmente associado com outras licenças e não pode ser excluído. Por favor, atualize suas licenças para não referenciar este :item e tente novamente.',
    ],
    ...
    'report_not_editable' => 'Você não tem permissão para editar este modelo de relatório',
    ...
    'token_unrevoked' => 'API token reativado',
    'token_revoked' => 'API token revogado',

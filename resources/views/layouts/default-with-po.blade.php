                        ...
                        @can('view', \App\Models\Asset::class)
                            <li class="treeview{{ (Request::is('purchase-orders*') ? ' active' : '') }}">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li class="{{ Request::is('purchase-orders') && request('status') == 'draft' ? 'active' : '' }}">
                                        <a href="{{ route('purchase-orders.index', ['status' => 'draft']) }}">
                                            <i class="fas fa-circle text-yellow fa-fw" aria-hidden="true"></i>
                                            Draft Orders
                                        </a>
                                    </li>
                                    <li class="{{ Request::is('purchase-orders') && request('status') == 'pending_approval' ? 'active' : '' }}">
                                        <a href="{{ route('purchase-orders.index', ['status' => 'pending_approval']) }}">
                                            <i class="fas fa-circle text-orange fa-fw" aria-hidden="true"></i>
                                            Pending Approval
                                        </a>
                                    </li>
                                    <li class="{{ Request::is('purchase-orders') && request('status') == 'ordered' ? 'active' : '' }}">
                                        <a href="{{ route('purchase-orders.index', ['status' => 'ordered']) }}">
                                            <i class="fas fa-circle text-blue fa-fw" aria-hidden="true"></i>
                                            Ordered
                                        </a>
                                    </li>
                                </ul>

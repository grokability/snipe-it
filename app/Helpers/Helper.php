...
class Helper
{
    ...
    */
    ...
    public static function SettingUrls(){
        $settings=['#','fields.index', 'statuslabels.index', 'models.index', 'categories.index', 'manufacturers.index', 'suppliers.index', 'departments.index', 'companies.index', 'depreciations.index'];
